    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            num_embedding_cols=num_embedding_cols,
            linear_skip_cols=linear_skip_cols,
            linear_skip_lr_factor=linear_skip_lr_factor,
            ...
            label_smoothing_schedule=label_smoothing_schedule,
            drop_last=drop_last,
            ema_decay=ema_decay,
            candidate_budget=candidate_budget,
            device=device,
            amp=amp,
            amp_predict=amp_predict,
            xla_fuse_steps=xla_fuse_steps,
            compile=compile,
            n_threads=n_threads,
            verbose=verbose,
